...
Anyone. Often Service providers like GitHub, Slack itself makes their own MCP server implementation. Even you can make a MCP server to wrap up access to some services.
...
In MCP, Tool schemas and functions already defined for you. Tools that you have to write manually and call by your self.